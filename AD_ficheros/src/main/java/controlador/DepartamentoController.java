...
public class DepartamentoController {
    ...
    public DepartamentoController() {
        ...
        ficheroDepartamento = new File("departamento.dat");
    }
    ...
    public void refrescarDepartamentos() throws IOException, FileNotFoundException, ClassNotFoundException {
        departamentos = departamentoController.LeerArchivoDepartamento(ficheroDepartamento);
    }
    ...
    public String[][] introducirDepartamento(ArrayList<Departamento> departamentos) throws IOException, FileNotFoundException, ClassNotFoundException {
        final int NUMERO_COLUMNAS = 5;
        String matriz[][] = new String[departamentos.size()][NUMERO_COLUMNAS];
