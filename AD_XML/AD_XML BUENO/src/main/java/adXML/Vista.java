...
public final class Vista extends javax.swing.JFrame {
    ...
    public Vista() throws IOException, FileNotFoundException, ClassNotFoundException, SAXException, ParserConfigurationException {
        ...
        refrescar_tabla_profesor(profesores.ComprobarFichero());
    ...
    private void boton_borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_borrarActionPerformed
        ...
        try {
            if(!departamento.comprobarfkDepartamento(colegio.getPosicionColegios(posicion).getCodigo())){
                System.out.println("fk no repetida");
              colegio.eliminarColegio(posicion);  
            }
            else{
    ...
    private void boton_aceptarProfesorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_aceptarProfesorActionPerformed
        ...
        if (!modificar_activado) {
            Profesor introducir = new Profesor(texto_dni.getText(), texto_nombreP.getText(), texto_apellido.getText(), texto_fecha_nacimiento.getText(), texto_sexo.getText(), fkProfesor.getSelectedItem().toString());
            try {
    ...
    private void borrar_departamentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_borrar_departamentoActionPerformed
        ...
        try {
            if(!profesores.comprobarfkProfesores(departamento.getPosicionDepartamentos(posicion).getCodDep()) ){

               departamento.eliminarDepartamento(posicion); 
            }
    ...
    private void aceptar_departamentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptar_departamentoActionPerformed
        ...
        if (!modificar_activado) {
            Departamento introducir = new Departamento(text_CodDep.getText(), texto_nombreD.getText(), texto_tipo.getText(), texto_numero_integrantes.getText(), texto_planta.getText(), fkDepartamento.getSelectedItem().toString());
            try {
    ...
    public void mostrarTuplaDepartamento(int i) {
        ...
        textofk_departamento.setText(departamento.getPosicionDepartamentos(i).getFk());
    ...
    public void mostrarTuplaProfesor(int i) {
        ...
        textoFK_profesor.setText(profesores.getPosicionProfesores(i).getFk());
