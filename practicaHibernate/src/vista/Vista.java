...
public class Vista extends javax.swing.JFrame {
    ...
    int idProfesor=0;
    public Vista() throws SAXException, IOException, ParserConfigurationException, FileNotFoundException, ClassNotFoundException {
        initComponents();
    ...
    private void modificar_departamentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificar_departamentoActionPerformed
        ...
        texto_tipo.setEditable(true);
        texto_numero_integrantes.setEditable(true);
    }//GEN-LAST:event_modificar_departamentoActionPerformed
    ...
    private void borrar_departamentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_borrar_departamentoActionPerformed
        ...
        try {
            if(!profesores.comprobarfkProfesores(departamento.getPosicionDepartamentos(posicion).getIdDepartamento()) ){

                departamento.eliminarDepartamento(departamento.getPosicionDepartamentos(posicion).getCodDep());
            }
    ...
    private void aceptar_departamentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptar_departamentoActionPerformed
        ...
        if (!modificar_activado) {
            ...
            Departamento introducir = new Departamento(idDepartamento,colegio.devolverColegio((int)fkDepartamento.getSelectedItem() ),text_CodDep.getText(), texto_nombreD.getText(), texto_tipo.getText(), texto_numero_integrantes.getText(), texto_planta.getText());
            try {
    ...
    private void boton_modificarProfesorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_modificarProfesorActionPerformed
        ...
        modificar_activado=true;
    }//GEN-LAST:event_boton_modificarProfesorActionPerformed
    ...
    private void boton_borrarProfesorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_borrarProfesorActionPerformed
        ...
        posicion = tabla_profesor.getSelectedRow();
        try {
            System.out.println(profesores.getPosicionProfesores(posicion).getIdProfesor());
            profesores.eliminarProfesor(profesores.getPosicionProfesores(posicion).getDni());
        } catch (IOException | ClassNotFoundException ex) {
            Logger.getLogger(Vista.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SAXException ex) {
            Logger.getLogger(Vista.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void boton_aceptarProfesorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_aceptarProfesorActionPerformed
        ...
        if (!modificar_activado) {
            ...
            Profesor introducir = new Profesor(idProfesor, departamento.devolverDepartamento((int)fkProfesor.getSelectedItem()),texto_dni.getText(), texto_nombreP.getText(), texto_apellido.getText(), texto_fecha_nacimiento.getText(), texto_sexo.getText());
            idProfesor++;
            try {
    ...
    private void boton_borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_borrarActionPerformed
        ...
        if(!departamento.comprobarfkDepartamento(colegio.getPosicionColegios(posicion).getIdColegio())){
            try {
                colegio.eliminarColegio(colegio.getPosicionColegios(posicion).getCodigo());
    ...
    private void boton_aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_aceptarActionPerformed
        ...
        if (!modificar_activado) {
            ...
            Colegio introducir = new Colegio(idColegio, texto_codigo.getText(), texto_nombre.getText(), texto_provincia.getText(), texto_direccion.getText(), texto_cp.getText());
            idColegio++;
            try {
    ...
    public void mostrarTuplaDepartamento(int i) {
        ...
        texto_planta.setText(departamento.getPosicionDepartamentos(i).getPlantaLocalizacion());
        textofk_departamento.setText(colegio.devolverCodigo(departamento.getPosicionDepartamentos(i).getIdDepartamento()));
    ...
    public void mostrarTuplaProfesor(int i) {
        ...
        textoFK_profesor.setText(departamento.devolverCodigo(profesores.getPosicionProfesores(i).getIdProfesor()));
    ...
    public void mostrarTupla(int i) {
        ...
        texto_provincia.setText(colegio.getPosicionColegios(i).getProvincia());
        texto_direccion.setText(colegio.getPosicionColegios(i).getDireccion());
        texto_cp.setText(colegio.getPosicionColegios(i).getCodigoPostal());
